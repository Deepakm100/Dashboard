  ...
  return (
    <div className="subgrid-two-item grid-common grid-c7">
        <div className="grid-c-title">
            <h3 className="grid-c-title-text">OverAll Progress</h3>
        ...
        <div className="grid-c7-content">
            ...
            <ul className="data-list">
                <li className="data-item text-silver-v1">
                    <span className="data-item-text">Lecture Target</span>
                    <span className="data-item-value">50 lectures</span>
                </li>
                <li className="data-item text-silver-v1">
                    <span className="data-item-text">Target Reached</span>
                    <span className="data-item-value">25 lectures</span>
                </li>
            </ul>
        </div>
    </div>
